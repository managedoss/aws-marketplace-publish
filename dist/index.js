...
const ruleset_1 = __nccwpck_require__(2510);
...
// src/MarketplaceCatalogClient.ts
var import_runtimeConfig = __nccwpck_require__(4506);
...
((EntityTypeFilters3) => {
  EntityTypeFilters3.visit = /* @__PURE__ */ __name((value, visitor) => {
    ...
    if (value.SaaSProductFilters !== void 0)
...
((EntityTypeSort3) => {
  EntityTypeSort3.visit = /* @__PURE__ */ __name((value, visitor) => {
    ...
    if (value.SaaSProductSort !== void 0)
      return visitor.SaaSProductSort(value.SaaSProductSort);
    if (value.AmiProductSort !== void 0)
...
// src/commands/BatchDescribeEntitiesCommand.ts
var _BatchDescribeEntitiesCommand = class _BatchDescribeEntitiesCommand extends import_smithy_client.Command.classBuilder().ep({
  ...commonParams
...
var _CancelChangeSetCommand = class _CancelChangeSetCommand extends import_smithy_client.Command.classBuilder().ep({
  ...commonParams
}).m(function(Command, cs, config, o) {
  return [
    (0, import_middleware_serde.getSerdePlugin)(config, this.serialize, this.deserialize),
...
var _StartChangeSetCommand = class _StartChangeSetCommand extends import_smithy_client.Command.classBuilder().ep({
  ...commonParams
}).m(function(Command, cs, config, o) {
  return [
    (0, import_middleware_serde.getSerdePlugin)(config, this.serialize, this.deserialize),
...
const package_json_1 = tslib_1.__importDefault(__nccwpck_require__(280));
...
const runtimeConfig_shared_1 = __nccwpck_require__(8488);
...
const endpointResolver_1 = __nccwpck_require__(3211);
const getRuntimeConfig = (config) => {
    return {
